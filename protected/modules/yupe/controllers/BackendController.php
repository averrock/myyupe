...
//use Gillbeits\CommerceML\CommerceMLParser;
...
class BackendController extends yupe\components\controllers\BackController
{
    ...
    {
        $importFile = Yii::app()->basePath.'../../stor/import___b815e2db-7a65-4265-9241-5f0c4f0565a7.xml';
        $offersFile = Yii::app()->basePath.'../../stor/offers.xml';
        
        $reader = new CommerceML($importFile,$offersFile);
        $data = $reader->getData();
/*        $pathToImportXmlFile=Yii::app()->basePath.'../../stor/import0_1.xml';
